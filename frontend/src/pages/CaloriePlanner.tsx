import { Box, Chip, CircularProgress, Grid, Tab, Tabs, Typography, useTheme } from '@mui/material';
import Fuse from 'fuse.js';
import React, { useCallback, useEffect, useMemo, useState } from 'react';
import FoodItemsList from '../components/caloriePlanner/FoodItemsList';
import SelectedItemsList from '../components/caloriePlanner/SelectedItemsList';
import { useDataStore } from '../store';
import { DailyItem } from '../types/ItemTypes';
import { SelectedDailyItem, SortDirection, SortKey, calculateNutritionTotals, getSavedItemsFromStorage } from '../util/caloriePlannerUtils';
